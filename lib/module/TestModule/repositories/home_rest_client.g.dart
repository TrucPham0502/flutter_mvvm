...
class _HomeRestClient implements HomeRestClient {
  ...
  @override
  Stream<ApiResponse<HomeResponse>> getData1() async* {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ApiResponse<HomeResponse>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/api/sme/CameraSetting',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = ApiResponse<HomeResponse>.fromJson(
      _result.data!,
      (json) => HomeResponse.fromJson(json as Map<String, dynamic>),
    );
    yield value;
